...
public class AuditTrail {
	...
	@Column(name = "VERSION_CREATED_DATE", nullable = false, insertable=true, updatable=false)
	Date createDate;

	@Column(name = "VERSION_CREATED_AGENTID", nullable = false, insertable=true, updatable=false) 
	...
	public String toString() {
		...
		sb.add("lastModifiedDate", lastModifiedDate);
		sb.add("lastModifiedAgentId", lastModifiedAgentId);
		sb.add("createDate", createDate);
		sb.add("createAgentId", createAgentId);
		return sb.toString();
	}
