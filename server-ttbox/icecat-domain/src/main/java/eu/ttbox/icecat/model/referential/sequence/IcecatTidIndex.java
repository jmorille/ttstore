...
@Entity
@Table(name = "TID_INDEX", schema = "icecat")
@SequenceGenerator(name = "seqTid", sequenceName = "SEQ_TID", schema = "icecat")
public class IcecatTidIndex implements IIcecatPersistantModelObject// PersistantModelObject<Integer>  
{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		IcecatTidIndex other = (IcecatTidIndex) obj;
		if (id == null) {
			if (other.id != null)
				return false;
