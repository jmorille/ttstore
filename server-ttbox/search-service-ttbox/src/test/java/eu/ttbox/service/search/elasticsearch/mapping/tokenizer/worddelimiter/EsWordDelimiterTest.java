package eu.ttbox.service.search.elasticsearch.mapping.tokenizer.worddelimiter;
...
public class EsWordDelimiterTest {

	private static Logger log = LoggerFactory.getLogger(EsWordDelimiterTest.class);
	...
	@Test
	@ElasticInitializerSetting(indexName = "wordidx", indexType = "france",pathSetting = "settings.json",  deleteAfter=false)
//	@ElasticInitializerMapping(pathMapping = "mappings.json")
	...
	public void showAnalysis() {
		for (String searchString : new String[] { "Wifi", "WiFi", "Wi-Fi","wi-fi-4000" ,"I-9100", "I9100", "Galaxy S2", "Galaxy SII", "j2se"}) {
			AnalyzeResponse response = client.admin().indices().prepareAnalyze("wordidx", searchString).setAnalyzer("word_analyzer").execute().actionGet();
