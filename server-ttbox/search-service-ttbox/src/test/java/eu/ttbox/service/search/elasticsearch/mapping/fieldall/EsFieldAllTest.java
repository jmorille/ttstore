package eu.ttbox.service.search.elasticsearch.mapping.fieldall;
...
public class EsFieldAllTest {

	private static Logger log = LoggerFactory.getLogger(EsFieldAllTest.class);
	 ...
	 */
	@Test
	@ElasticInitializerSetting(indexName = "fieldall", indexType = "france", pathSetting = "settings.json", deleteBefore = true, deleteAfter = false)
