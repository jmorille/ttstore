package eu.ttbox.service.search.elasticsearch.mapping.lang.language;
...
public class EsLanguageTest {

	private static Logger log = LoggerFactory.getLogger(EsLanguageTest.class);
	...
	public void showAnalysis() {
		for (String searchString : new String[] { "Manger", "il a menti", "l'avion est parti pour la Suisse" }) {
			AnalyzeResponse response = client.admin().indices().prepareAnalyze("snow", searchString).setAnalyzer("french").execute().actionGet();
