...
<%
        ...
        <%= jProperty.writeOverride ? "override " : "" %>public function set ${jProperty.name}(value:${jProperty.as3Type.name}):void {
        ...
        <%= jProperty.readOverride ? "override " : "" %>public function get ${jProperty.name}():${jProperty.as3Type.name} {
