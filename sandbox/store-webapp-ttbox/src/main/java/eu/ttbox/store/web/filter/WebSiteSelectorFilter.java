package eu.ttbox.store.web.filter;
...
public class WebSiteSelectorFilter extends GenericFilterBean {
    ...
    public static final String UNVAILABLE_URL ="/ttbox/store/unvailable";
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
        ...
        if (webSite != null) {
            ...
            if (isActif) {
                ...
                if (WebSiteAccessMode.INACCESSIBLE==acccesMode) {
                    //TODO  response.sendRedirect(UNVAILABLE_URL);
                }

            }
        } else {
            response.sendRedirect(UNVAILABLE_URL);
        }
