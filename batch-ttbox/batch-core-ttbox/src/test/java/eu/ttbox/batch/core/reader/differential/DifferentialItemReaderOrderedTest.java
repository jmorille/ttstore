...
public class DifferentialItemReaderOrderedTest {
    private static final Logger log = LoggerFactory.getLogger(DifferentialItemReaderOrderedTest.class);
	...
	DifferentialOrderedItemReader<String, String> service = new DifferentialOrderedItemReader<String, String>(masterReader, joinReader, 
		comparator);
	service.open(null);
